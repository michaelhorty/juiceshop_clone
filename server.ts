...
const dnsLookup = require('./routes/dnsLookup')
const reverseDnsLookup = require('./routes/reverseDnsLookup')
...
restoreOverwrittenFilesWithOriginals().then(() => {
  ...
  app.post('/rest/dns-lookup', dnsLookup())
  app.post('/rest/reverse-dns-lookup', reverseDnsLookup())
  app.post('/rest/ping', ping())
  /* NoSQL API endpoints */
